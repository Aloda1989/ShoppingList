...
import shoppingList.entity.Order;
import shoppingList.entity.OrderDetail;
...
@Transactional
public class OrderUpaImpl implements OrderUpa {
    @Autowired
    ...
    public void saveOrder(CartInfo cartInfo) {
        ...
        for (CartLineInfo line : lines) {
            ...
            Product product = this.productUpa.findProduct(code);
